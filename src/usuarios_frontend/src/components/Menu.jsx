  ...
  return (
        ...
        { principal ? ( 
            <div className="container-fluid">
                    ...
                    <Link to='/BookCreate' className="navbar-brand" >Nuevo</Link> 
                    <Link to='/Books' className="navbar-brand" id="btnBookList">Books</Link> 
                    <Link to='/otro' className="navbar-brand" id="btnUserOtro">Otro link</Link>
